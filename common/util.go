...
// StartBackground 后台启动进程，日志输出到指定文件，可选端口检测，返回错误
func StartBackground(logFile string, checkPort string, command string, args ...string) error {
...
// StartBackgroundNoCheck 后台启动进程，不做任何存活检测，返回错误
func StartBackgroundNoCheck(command string, args ...string) error {
